package com.result.homepage.custom;
...
/**
 * ZoomImageView，安卓自定义缩放图片的控件，支持双击放大双击缩小，
 * 多点触控拉伸放大与缩小，并且很好的控制了图片的位置，不会出现缩
 * 小图片后图片左右出现空白的情况，缩小到默认值的时候，图片会居中
 * 填充窗口
 */
public class CustomImageView extends ImageView implements OnGlobalLayoutListener,
